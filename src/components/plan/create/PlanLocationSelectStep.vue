...
<template>
    <div class="plan-location-select-step">
      ...
      <div class="bottom-navigation">
        <button class="step-back-btn" @click="handlePrevious">
      ...
      <div 
        ...
        :class="{ show: attractions.length > 0, collapsed: searchResultsCollapsed }"
      >
        <div class="search-results-header" @click="toggleSearchResults">
          <div class="header-content">
            ...
            <div class="header-actions">
              ...
              <button 
                class="toggle-search-results" 
                :class="{ collapsed: searchResultsCollapsed }"
              >
  ...
  const parseSearchKeyword = (keyword) => {
    const areaMapping = {
      ...
      전남: '38', 전라남도: '38',
      제주: '39', 제주특별자치도: '39', 제주도: '39',
      전주: '37', 여수: '38', 순천: '38', 목포: '38',
      포항: '35', 경주: '35', 안동: '35',
      창원: '36', 김해: '36', 진주: '36',
      춘천: '32', 원주: '32', 강릉: '32', 속초: '32',
      청주: '33', 충주: '33',
      천안: '34', 공주: '34', 부여: '34',
      수원: '31', 성남: '31', 고양: '31', 용인: '31'
    }
