              ...
              <div v-for="day in dayCount" :key="day" v-show="activeDay === day">
                <div class="day-header mb-3">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="day-actions">
                      <button 
                        ...
                        @click="addManualAttraction(day)"
                      >
                        <i class="fas fa-plus me-1"></i>직접 추가
                      </button>
                      <button 
                        class="btn btn-sm btn-outline-info" 
                        @click="optimizeSchedule(day)"
                      >
                  ...
                  <div class="day-summary">
                    총 {{ getDayAttractions(day).length }}개 일정, 
                    예상 소요시간: {{ calculateTotalTime(day) }}
                  </div>
                </div>
          ...
          <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <div class="save-actions">
              ...
              <button 
                ...
                @click="handleSave" 
                :disabled="isSaving || !isValidSchedule"
              >
                <span v-if="isSaving">
                ...
                <span v-else>
                  <i class="fas fa-check me-2"></i>여행 계획 완성
                </span>
              </button>
            </div>
          </div>
